                                                            ...
                                                            <tbody class="data textAlign">
                                                                @foreach ($dataDetail as $detail)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $detail->berat }}</td>
                                                                        <td>{{ $detail->qty }}</td>
                                                                        <td><a href="{{ route('bahan_baku.keluar.detail.delete', [$data->id, $detail->id, $gudangRequest]) }}" class='btn btn-sm btn-block btn-danger' style='width:40px;'><span class='fa fa-trash'></span></a></td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>                                                                                       
                                                        </table>
