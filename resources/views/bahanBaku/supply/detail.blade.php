                     ...
                     <div class="card">
                         <div class="card-body">
                             <form id="demo-form2" data-parsley-validate method="POST" enctype="multipart/form-data"
                                 action="{{ route('bahan_baku.supply.update', ['id' => $data->id]) }}">
                                                 ...
                                                 <div class="row">
                                                     <div class="col-4">
                                                         <div class="form-group">
                                                             ...
                                                             <input type="text" class="form-control kodePurchase"
                                                                 id="kodePurchase" name="kodePurchase"
                                                                 value="{{ $data->purchase->kode }}" readonly />
                                                             <input type="hidden" class="form-control purchaseId"
                                                                 id="purchaseId" name="purchaseId"
                                                                 value="{{ $data->purchaseId }}" readonly />
                                                         </div>
                                                     </div>
                                                     ...
                                                     <div class="col-4">
                                                         <div class="form-group">
                                                             ...
                                                             <input class="form-control suplier" required id="suplier"
                                                                 name="namaSuplier" type="text"
                                                                 placeholder="Nama Suplier" value="{{ $data->namaSuplier }}"
                                                                 readonly>
                                                         </div>
                                                     </div>
                                                     <div class="col-4">
                                                         <div class="form-group">
                                                             ...
                                                             <input type="text" class="form-control total" required
                                                                 id="total" name="total"placeholder="Total"
                                                     ...
                                                     @foreach ($barangDatang as $value)
                                                         <p>Waktu Kedatangan :
                                                             {{ date('j F Y H:i:s', strtotime($value->created_at)) }}</p>
                                                         <div class="col-12 right">
                                                             <table id="materialPO"
                                                                 class="table table-bordered dataTables_scrollBody"
                                                                 style="width: 100%">
                                                                 <thead>
                                                                     <tr>
                                                                         ...
                                                                         <th class="textAlign">Jumlah Roll</th>
                                                                 ...
                                                                 <tbody class="data textAlign">
                                                                     ...
                                                                     @foreach ($value->detail as $key => $detail)
                                                                         ...
                                                                         <tr>
                                                                             <td colspan="5"></td>
                                                                             <td> {{ $detailMaterial->jumlahRoll }} Roll </td>
                                                                             <td>
                                                                                 {{ $detailMaterial->diameter }}
                                                                             </td>
                                                                             <td>
