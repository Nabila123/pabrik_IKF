...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> Tambah Data Purchase Request</h1>
                </div>
                <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" id="pengajuanDate" name="pengajuanDate" class="form-control pengajuanDate" value="{{ date('d F Y') }}" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                                        </div>
                                    </div> 
                                    <div class="col-6">
