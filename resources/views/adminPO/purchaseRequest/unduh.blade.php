...
<body>
    <table class='text-center' style="width: 100%; margin-bottom:10px;">
        ...
        <tr>
            <th style="font-size: 16px"> <u>Purchase Request</u></th>
        </tr>
    </table>
    ...
    <table class="text-center" style="width: 100%; margin-bottom:6em;">
        ...
        <tr>
            <td style="font-size: 12px"> Kepala Departemen Produksi </td>
            <td style="font-size: 12px"> Kepala Departemen PO </td>
        </tr>
        <tr>
    ...
    <footer>
        Copyright &copy; Purchase Request / 02 
    </footer>
</body>
</html>