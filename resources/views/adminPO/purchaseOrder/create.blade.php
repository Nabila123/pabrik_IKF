                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control purchaseKode" id="purchaseKode" name="purchaseKode"  type="text" placeholder="Kode Purchase">                                            
                                        </div>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="pengirimanDate" name="pengirimanDate" class="form-control pengirimanDate" value="{{ date('d F Y') }}" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask >
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="jatuhTempoDate" name="jatuhTempoDate" class="form-control jatuhTempoDate" value="{{ date('d F Y') }}" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask >
                                        </div>
                                    </div>
                                    <div class="col-12">
