                                ...
                                <div class="row"> 
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control purchaseKode disabled" type="text" id="purchaseKode" name="purchaseKode" value="{{ $purchase->purchase->kode }}" placeholder="Kode Purchase" readonly>                                                                                      
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control total" id="total" name="total" value="{{ $invoice->total }}" type="number" placeholder="Total Harga" required>                                            
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <label>Tanggal Jatuh Tempo <sup>(Optional)</sup></label>
                                        <div class="input-group date" id="DateJatuhTempo">
                                            <input type="date" id="paymentDue" name="paymentDue" value="{{ $invoice->paymentDue }}" class="form-control datetimepicker-input paymentDue" data-target="#DateJatuhTempo"/>
                                        </div>
                                    </div>
                                    <div class="col-12">
