     ...
     <script type="text/javascript">
         ...
         $(document).ready(function() {
             $(document).on("click", "button.TData", function(e) {
                 ...
                 if (pegawaiId != "Pilih Satu Pegawai" && pegawaiId != "" && purchaseId != "" && jenisBaju !=
                     ...
                     if (jumlahBaju != null) {
                         table += "<td>" + jumlahBaju +" "+ textJumlah + "<input type='hidden' name='jumlahBaju[]' value='" +
                             jumlahBaju + "' id='jumlahBaju_" + jumlah_data + "'></td>";
                     } else {
                         table += "<td>" + jumlahBajuPcs +" "+ textJumlah + "<input type='hidden' name='jumlahBaju[]' value='" +
