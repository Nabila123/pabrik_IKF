...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> Reject From Batil</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Reject From Batil</li>
                                            ...
                                            <tbody class="data textAlign">
                                                ...
                                                @foreach ($jahitRejectDetail as $detail)
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a href="{{ route('GPacking.reject.update.delete', [$gdJahitReject->id, $detail->id]) }}" class="btn btn-sm btn-block btn-danger" style="width:40px;"><span class="fa fa-trash"></span></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
