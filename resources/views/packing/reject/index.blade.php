...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Gudang Packing Reject</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Gudang Packing Reject</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">   
                        <div class="card-header">
                            <h3 class="card-title" style="width: 100%">
                                <a href="{{ route('GPacking.reject.create') }}" class='btn btn-info btn-flat-right'>Kembalikan Barang</a>
                            </h3>                           
                        </div>                   
                        <div class="card-body">
                                ...
                                <tbody class="textAlign">
                                   ...
                                   @foreach ($gdControlReject as $reject)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('GPacking.reject.detail', [$reject->id]) }}" class='btn btn-warning'><i class="fas fa-list-ul" style="font-size: 14px"></i></a>
                                                @if ($reject->statusProses == 0)
                                                    <a href="{{ route('GPacking.reject.update', [$reject->id]) }}" class='btn btn-success'><i class="fas fa-pencil-alt" style="font-size: 14px"></i></a>
...
@push('page_scripts') 
    <script type="text/javascript">
        ...
        {
            var id = id;
            var url = '{{ route('GPacking.reject.delete') }}';
