                     ...
                     <div class="card">
                         @if (\Auth::user()->roleId == 1 ||
                             ...
                             <div class="card-header">
                                 <h3 class="card-title">
                                     <a href="{{ route('GPotong.proses.create') }}"
                                 ...
                                 <tbody class="textAlign">
                                     @foreach ($gdPotongProses as $proses)
                                         <tr>
                                             ...
                                             <td>{{ $proses->qty }}</td>
                                             <td>
                                                 <a href="{{ route('GPotong.proses.detail', $proses->id) }}"
                                                 ...
                                                 @if (\Auth::user()->roleId == 1 ||
                                                     ...
                                                     \Auth::user()->roleId == 7 ||
                                                     \Auth::user()->roleId == 17)
                                                     <a href="{{ route('GPotong.proses.update', $proses->id) }}"
                                                 ...
                                                 @if (\Auth::user()->roleId == 1 ||
                                                     ...
                                                     <button type="button" data-toggle="modal"
                                                         potongProsesId='{{ $proses->id }}' data-target="#DeleteModal"
                                                         id="modalDelete" onclick='deleteData("{{ $proses->id }}")'
