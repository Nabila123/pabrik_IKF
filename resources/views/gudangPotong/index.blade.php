...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                @foreach($dataKain as $kain)
                    <div class="col-12 col-sm-12 col-md-4">
                        <div class="info-box mb-4">
                            <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-list-alt"></i></span>
                            <div class="info-box-content">
                                <span class="info-box-text">{{strtoupper($kain['nama'])}}</span>
                                <span class="info-box-number"> 
                                    {{$kain['berat']}} Kg
                                    <span style="float: right"> {{$kain['qty']}} Roll </span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-4">
                        <div class="info-box mb-4">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"> {{$stok['qty']}} Dz</span>
                            </div>
                        </div>
                    </div>
                @endforeach
