...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Detail Potong Reject</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Potong Reject</li>
                                ...
                                <tbody class="textAlign">
                                    ...
                                    @foreach ($jahitRejectDetail as $detail)
                                        <tr>
                                            ...
                                            <td>{{ $detail->bajuOpname->jenisBaju }}</td>
                                            <td>{{ $detail->bajuOpname->ukuranBaju }}</td>
                                            <td>
                                                @if ($detail->keterangan == null || $detail->keterangan == " ")
                                                     -
                                                @else
                                                    {{ $detail->keterangan }}
                                                @endif    
