                                    ...
                                    @for ($i = 0; $i < count($data); $i++)
                                        @for ($j = 0; $j < count($data[$i]); $j++)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('GBahanPembantu.masuk.detail',['id'=>$data[$i][$j]->id, 'gudangRequest'=>$data[$i][$j]->gudangRequest])}}" class='btn btn-warning'><i class="fas fa-list-ul" style="font-size: 14px"></i></a>
