...
@section('content')
                                ...
                                <tbody>
                                    @foreach($data as $key=>$value)
                                        <tr>
                                            ...
                                            <td>{{$value->barangDatang->namaSuplier}}</td>
                                            <!-- <td>{{$value->total}}</td> -->
                                            <td>
    ...
    <div id="DeleteModal" class="modal fade">
        <div class="modal-dialog ">
            <!-- Modal content-->
            <form action="{{ route('GBahanPembantu.supply.delete') }}" id="deleteForm" method="post" >
...
@push('page_scripts') 
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            {
                var id = id;
                var url = '{{ route('GBahanPembantu.supply.delete') }}';
