                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="nip"  type="text" placeholder="No Absen" value="" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <label>Nama</label>
                                        <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama User" value="" required>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
