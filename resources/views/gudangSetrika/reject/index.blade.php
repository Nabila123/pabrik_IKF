...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Gudang Setrika Reject</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Gudang Setrika Reject</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">   
                        <div class="card-header">
                            <h3 class="card-title" style="width: 100%">
                                <a href="{{ route('GSetrika.reject.create') }}" class='btn btn-info btn-flat-right'>Kembalikan Barang</a>
                            </h3>                           
                        </div>                   
                        <div class="card-body">
                            <table id="operator" class="table table-bordered dataTables_scrollBody" style="width: 100%">
                                ...
                                <tbody class="textAlign">
                                    <?php $no = 1; ?>
                                   @foreach ($controlReject as $reject)
                                        <tr>
                                            <td>{{ $no++ }}</td>
...
@push('page_scripts') 
    <script type="text/javascript">
        ...
        {
            var id = id;
            var url = '{{ route('GSetrika.reject.delete') }}';
