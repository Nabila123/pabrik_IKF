                                 ...
                                 <div class="row">
                                     <div class="col-4">
                                         <div class="form-group">
                                             ...
                                             <input type="text" id="kodeTransaksi" name="kodeTransaksi"
                                                 value="{{ $kodeTransaksi }}" class="form-control kodeTransaksi disable"
                                                 readonly>
                                         ...
                                         <div class="card card-info">
                                             ...
                                             <div class="card-body">
                                                 <div class="row">
                                                     <div class="col-2">
                                                         <div class="form-group">
                                                             <label>Kode Barang <sup>Barcode</sup> </label>
                                                             <input type="text" id="kodeProduct" name="kodeProduct"
                                                                 class="form-control kodeProduct">
                                                             <input type="hidden" id="kodeProductNew" name="kodeProductNew"
                                                                 class="form-control kodeProductNew">
                                                         </div>
                                                     </div>
                                                     <div class="col-4">
                                                         <div class="form-group">
                                                             <label>Jenis Baju</label>
                                                             <div id="updateJenisBaju">
                                                                 <select class="form-control jenisBaju" id="jenisBaju"
                                                                     name="jenisBaju" style="width: 100%; height: 38px;">
                                                                     <option> Pilih Satu Jenis Baju</option>
                                                                     @foreach ($jenisBaju as $baju)
                                                                         <option value="{{ $baju->jenisBaju }}">
                                                                             {{ $baju->jenisBaju }}</option>
                                                                     @endforeach
                                                                 </select>
                                                             </div>
                                                         </div>
                                                     ...
                                                     <div class="col-2">
                                                         <div class="form-group">
                                                             ...
                                                             <input type="text" class="form-control jumlahBaju"
                                                                 name="jumlahBaju" id="jumlahBaju">
                                                     ...
                                                     <div class="col-2">
                                                         <div class="form-group">
                                                             ...
                                                             <input type="text" class="form-control jumlahDz"
                                                                 name="jumlahDz" id="jumlahDz">
                                                         </div>
                                                     </div>
                                                     <div class="col-2">
                                                         <div class="form-group">
                                                             <input type="hidden" class="form-control hargaBaju"
                                                                 name="hargaBaju" id="hargaBaju" value="0">
     ...
     <script type="text/javascript">
             ...
             if (kodeProduct != "" && kodeProduct.length == 12) {
                 $.ajax({
                     ...
                     success: function(response) {
                         ...
                         $('#updateJenisBaju').html(data.jenisBaju);
                         $('#updateUkuranBaju').html(data.ukuranBaju);
                         $('#jumlahBaju').val(data.jumlahDus);
                         $('#jumlahDz').val(data.jumlahDz);
                         $('#kodeProductNew').val(data.kodeProduct);
                         $('#requestOperatorId').html(data.requestOperator);
                     }
                 })
         ...
         $(document).on("change", ".ukuranBaju", function() {
             ...
             $.ajax({
                 ...
                 success: function(response) {
                     ...
                     $('#jumlahDz').val(data['operator']['jumlahBaju'] / 2);
             ...
             if (parseInt(jumlahBaju) <= parseInt(jumlahBajuOld)) {
                 $.ajax({
                     ...
                     success: function(response) {
                         ...
                         $('#jumlahBaju').val(data['operator']['jumlahBaju'] * 2);
                         $('#jumlahDz').val(data['operator']['jumlahBaju']);
                         for (var i = 0; i < data.operator.requestOperatorId.length; i++) {
                             var dt = "<input type='hidden' name='requestOperatorId[]' value='" + data[
                                     'operator']['requestOperatorId'][i] + "' id='requestOperatorId_" +
                                 i + "'>";
         ...
         $(document).ready(function() {
             $(document).on("click", "button.TData", function(e) {
                 ...
                 var kodeProduct = $('#kodeProductNew').val() == "" ? " - " : $('#kodeProductNew').val();
                 var jenisBaju = $('#jenisBaju').val();
                 var ukuranBaju = $('#ukuranBaju').val();
                 var jumlahBaju = $('#jumlahBaju').val();
                 ...
                 totalAkhir = parseInt(totalHarga) + (parseInt(hargaBaju.replace(/[^0-9]/g, '')) *
                     parseFloat(jumlahDz));
                 ...
                 if (kategori != "" && jenisBaju != "" && ukuranBaju != "" && jumlahBaju != "" && hargaBaju != "") {
                     ...
                     table += "<td>" + jumlah_data + "<input type='hidden' name='operatorReqId[]' value='" +
                         operatorReqId + "' id='operatorReqId_" + jumlah_data + "'></td>";
                     table += "<td>" + kodeProduct + "<input type='hidden' name='kodeProduct[]' value='" +
                         kodeProduct + "' id='kodeProduct_" + jumlah_data + "'></td>";
                     ...
                     table += "<td>" + jumlahBaju + "<input type='hidden' name='jumlahBaju[]' value='" +
                         jumlahBaju + "' id='jumlahBaju_" + jumlah_data + "'></td>";
                     table += "<td>" + jumlahDz + "<input type='hidden' name='jumlahDz[]' value='" +
                         jumlahDz + "' id='jumlahDz_" + jumlah_data + "'></td>";
                     table += "<td><input type='hidden' name='hargaBaju[]' value='" +
                         parseInt(hargaBaju.replace(/[^0-9]/g, '')) + "' id='hargaBaju_" + jumlah_data +
                         "'>";
