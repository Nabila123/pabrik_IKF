                                            ...
                                            <tbody class="data textAlign">
                                                ...
                                                @foreach ($jahitRejectDetail as $detail)
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a href="{{ route('GBatil.reject.update.delete', [$gdJahitReject->id, $detail->id]) }}" class="btn btn-sm btn-block btn-danger" style="width:40px;"><span class="fa fa-trash"></span></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
