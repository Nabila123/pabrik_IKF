...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Gudang Batil Operator</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Gudang Batil Operator</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">   
                        <div class="card-header">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#PindahLink" data-toggle="tab">Pindah Ke Control</a></li>
                                ...
                                <div class="active tab-pane" id="OperatorLink">
                                    @if (\Auth::user()->roleId == 1 || \Auth::user()->roleId == 4 || \Auth::user()->roleId == 7 || \Auth::user()->roleId == 19)
                                        <h3 class="card-title mb-4" style="width: 100%">
                                            <a href="{{ route('GBatil.operator.create') }}" class='btn btn-info btn-flat-right'>Ambil Barang</a>
                                        </h3>
                                    @endif
                                        ...
                                        <tbody class="textAlign">
                                            @foreach ($operatorRequest as $detail)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('GBatil.operator.detail', [$detail->jenisBaju, $detail->ukuranBaju]) }}" class='btn btn-warning'><i class="fas fa-list-ul" style="font-size: 14px"></i></a>
                                                        
                                                        @if (\Auth::user()->roleId == 1 || \Auth::user()->roleId == 4 || \Auth::user()->roleId == 7 || \Auth::user()->roleId == 19)
                                                            <a href="{{ route('GBatil.operator.update', [$detail->jenisBaju, $detail->ukuranBaju]) }}" class='btn btn-success'><i class="fas fa-pencil-alt" style="font-size: 14px"></i></a>
                                                        @endif
                                                        @if (\Auth::user()->roleId == 1 || \Auth::user()->roleId == 4 || \Auth::user()->roleId == 7 || \Auth::user()->roleId == 19)
                                                            @if (count($gdBatil) == 0)
                                                ...
                                                <tbody class="textAlign">
                                                    @for ($i = 0; $i < count($dataPemindahan); $i++)                                                        
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if (\Auth::user()->roleId == 1 || \Auth::user()->roleId == 4 || \Auth::user()->roleId == 7 || \Auth::user()->roleId == 19)
                                                                    <a href="{{ route('GBatil.keluar.create',[$dataPemindahan[$i]['jenisBaju'], $dataPemindahan[$i]['ukuranBaju'], date('Y-m-d', strtotime($dataPemindahan[$i]['tanggal']))]) }}" title="Pindahkan Barang" class='btn btn-info btn-flat-right'><i class="fa-solid fa-arrow-right-arrow-left" alt="Pindahkan Barang"></i> <small> Pindahkan Barang</small></a>
                                                                @endif
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <h6 class="mt-4 text-danger text-sm"> Nb : Data Yang Ditampilkan
                                                        Merupakan Data Yang Sudah Melewati Proses Batil
                                                    </h6>
                                                </div>
                                            </div>
                                        </form>
