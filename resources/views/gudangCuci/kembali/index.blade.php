 ...
 @section('content')
     <section class="content-header">
         <div class="container-fluid">
             <div class="row mb-2">
                 <div class="col-sm-6">
                     <h1>Gudang Cuci Pemindahan</h1>
                 </div>
                 <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                         <li class="breadcrumb-item"><a href="#">Home</a></li>
                         <li class="breadcrumb-item active">Pemindahan Ke Gudang Compact</li>
                     </ol>
                 </div>
             </div>
         </div>
                                 ...
                                 <tbody class="textAlign">
                                     @foreach ($gCuciKembali as $kembali)
                                         <tr>
                                             ...
                                             <td>
                                                 <a href="{{ route('GCuci.kembali.detail', [$kembali->id]) }}"
             ...
             <form id="deleteForm" method="post">
                 <div class="modal-content">
                     ...
                     <div class="modal-body">
                         ...
                         <input type="hidden" name="gdCuciKId" id="gdCuciKId">
                     </div>
 ...
 @push('page_scripts')
     <script type="text/javascript">
         function deleteData(id) {
             var id = id;
             var url = '{{ route('GCuci.kembali.delete') }}';
