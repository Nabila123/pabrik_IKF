...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $rol = [
            ...
            ['id' => 2, 'nama' => 'Developer', 'created_at' => date('Y-m-d H:i:s')],
            ...
            ['id' => 12, 'nama' => 'Kepala Bagian Gudang Bahan Baku', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => 13, 'nama' => 'Kepala Bagian Rajut', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => 14, 'nama' => 'Kepala Bagian Cuci', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => 15, 'nama' => 'Kepala Bagian Compact', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => 16, 'nama' => 'Kepala Bagian Inspeksi', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => 17, 'nama' => 'Kepala Bagian Potong', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => 18, 'nama' => 'Kepala Bagian Jahit', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => 19, 'nama' => 'Kepala Bagian Gudang Batil', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => 20, 'nama' => 'Kepala Bagian Kontrol', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => 21, 'nama' => 'Kepala Bagian Setrika', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => 22, 'nama' => 'Kepala Bagian Packing', 'created_at' => date('Y-m-d H:i:s')],
